...
@property (nonatomic, strong) UIButton *currentPointBtn;
...
- (void)drawXYLine{
    ...
    [path moveToPoint:CGPointMake(kMargin, CGRectGetHeight(myFrame)-kMargin)];
...
//    [path addLineToPoint:CGPointMake(CGRectGetWidth(myFrame) - kMargin / 2.0 - 4, CGRectGetHeight(myFrame) - kMargin + 5)];
    ...
    layer.strokeColor = [UIColor colorWithRed:244/255.0 green:244/255.0 blue:244/255.0 alpha:1].CGColor;
...
- (void)drawLabels{
    ...
    for(int i = 0; i <= yCount; i ++){
        ...
        lbl.textColor = [UIColor colorWithRed:157/255.0 green:157/255.0 blue:157/255.0 alpha:1];
...
- (void)drawPointsWithPointType:(PointType)pointType{
    ...
    for (int i = 0; i < count; i ++) {
        ...
        UIBezierPath *path = [UIBezierPath
                              ...
                              //    方法2
                              bezierPathWithRoundedRect:CGRectMake(point.x - 5, point.y - 5, 10, 10) cornerRadius:5];
        
        
        CAShapeLayer *layer = [CAShapeLayer layer];
        
        layer.path = path.CGPath;
        layer.strokeColor = [UIColor colorWithRed:239/255.0 green:236/255.0 blue:183/255.0 alpha:1].CGColor;
        layer.fillColor = [UIColor colorWithRed:255/255.0 green:252/255.0 blue:131/255.0 alpha:1].CGColor;
        layer.borderWidth = 2;
        layer.borderColor = [UIColor colorWithRed:239/255.0 green:236/255.0 blue:183/255.0 alpha:1].CGColor;
        [self.bgView.layer addSublayer:layer];
    }
...
- (void)drawPillar{
    for (int i = 0; i < count; i ++) {
        ...
        CAShapeLayer *layer = [[CAShapeLayer alloc] init];
        layer.path = path.CGPath;
        layer.strokeColor = [UIColor colorWithRed:248/255.0 green:50/255.0 blue:60/255.0 alpha:1].CGColor;
